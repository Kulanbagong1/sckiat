...
# download script
cd /usr/bin
wget -O port-xray "https://raw.githubusercontent.com/${GitUser}/sckiat/main/change-port/port-xray.sh"
wget -O certv2ray "https://raw.githubusercontent.com/${GitUser}/sckiat/main/cert.sh"
wget -O trojaan "https://raw.githubusercontent.com/${GitUser}/sckiat/main/menu/trojaan.sh"
wget -O xraay "https://raw.githubusercontent.com/${GitUser}/sckiat/main/menu/xraay.sh"
chmod +x port-xray
chmod +x certv2ray
chmod +x trojaan
chmod +x xraay
